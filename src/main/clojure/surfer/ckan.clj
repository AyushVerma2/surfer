...
(defn import-package 
  ...
  ([db repo package-name]
    (import-package db repo package-name {}))
  ([db repo package-name options]
...
(defn import-packages [db repo package-names]
  (doall (pmap #(import-package db repo % ) package-names)))

(defn import-all [db repo]
  (let [packages (package-list repo)]
    (doseq [p packages] (import-package db repo p))
